...
<body>
  ...
  <div class="form-container">
    ...
    <form method="POST" action="">
      <div class="input-group" <?php if ($errors['name']) {print 'class="error"';} ?>>
      ...
      <div class="input-group" <?php if ($errors['email']) {print 'class="error"';} ?>>
      ...
      <div class="input-group <?php if ($errors['birth']) {print 'class="error"';} ?>">
      ...
      <div class="form-check" id="gender-block" <?php if ($errors['gender']) {print 'class="error"';} ?>>
      ...
      <div class="form-check">
        <input class="form-check-input" type="checkbox" value="y" id="policy" name="policy" <?php if ($errors['policy']) {print 'class="error"';} ?> <?php if($values['policy'] == 'y'){print('checked');}; ?> />
